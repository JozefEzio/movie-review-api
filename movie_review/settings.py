...
SECRET_KEY = 'django-insecure-5g+jevmxvj8!@p3$idahyhc0b8r(5(pa&p(-i2a0cy*yhp%(_2'
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        ...
        'rest_framework.authentication.TokenAuthentication',    # optional, for API token usage
    ],
    ...
    "PAGE_SIZE": 10,  # global pagination fallback
}
